...
```markdown
 6 : ⭕️ true: 0.415 < hyoka_accuracy: 0.414 before compare path Images\run\face_1.gif
 8 : ⭕️ true: 0.415 < hyoka_accuracy: 0.392 before compare path Images\run\face_2.gif
```
